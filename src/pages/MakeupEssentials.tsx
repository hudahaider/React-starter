...
// 1. Added the missing Product type definition
type Product = {
  id: string;
  img: string;
  title: string;
...
const MakeupEssentials = () => {
  ...
  // 2. FIXED: Renamed this variable to avoid conflict with the component name
  ...
  return (
    <div className="bg-pink-200 dark:bg-slate-950  min-h-screen font-sans p-10">
      ...
      <div id="shop-all" className="max-w-7xl mx-auto mt-16">
        ...
        {/* 3. Updated mapping to use the new variable name */}
