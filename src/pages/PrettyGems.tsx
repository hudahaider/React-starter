...
const PrettyGems = () => {
  ...
  // 2. FIXED: Renamed internal variable to 'filteredGems' to avoid component name conflict
  const filteredGems = Products.filter((p) => p.category === "PreetyGems");
