...
const Footer = () => {
  return (
    <footer className="bg-pink-200 dark:bg-slate-950 py-5 px-6 lg:px-20 border-black border-t ">
      <div className="max-w-7xl mx-auto grid md:grid-cols-2 gap-10 items-center mt-10">
        {/* Left Side */}
        <div>
          <h1 className="text-4xl font-serif tracking-widest text-gray-800 dark:text-white">
            VELOURA
          </h1>
        ...
        {/* Right Side */}
        <div>
          <h2 className="text-lg font-semibold text-gray-800 dark:text-gray-400 mb-3">
            Veloura Beauty
          </h2>
      ...
      {/* Social Icons */}
      <div className="flex justify-center gap-6 mt-20 text-gray-700 dark:text-gray-400">
      ...
      {/* Bottom */}
      <div className="text-center text-gray-600 dark:text-gray-400 text-sm mt-7">
